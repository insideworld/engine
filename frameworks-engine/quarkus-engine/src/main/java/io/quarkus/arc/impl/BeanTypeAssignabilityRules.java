...
//        if (requiredParameter instanceof WildcardType && beanParameter instanceof WildcardType) {
//            var required = (WildcardType) requiredParameter;
//            var bean =  (WildcardType) beanParameter;

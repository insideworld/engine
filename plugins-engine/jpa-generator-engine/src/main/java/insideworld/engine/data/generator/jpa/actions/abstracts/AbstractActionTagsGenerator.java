...
public abstract class AbstractActionTagsGenerator<T extends ActionTagsInfo> extends AbstractActionTagGenerator<T> {

    public AbstractActionTagsGenerator(final ClassOutput output, final String packages) {
